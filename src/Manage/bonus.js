...
const Loan = () => {
    ...
    useEffect (()=>{
      ...
      const getData = async () =>{
        const data = await fetch ("https://server0826.herokuapp.com/hr/"+state._id+"/loan-reqs/1");
      ...
      const accept = (e)=>{
        ...
        fetch ("https://server0826.herokuapp.com/hr/"+state._id+"/loan-reqs/"+e.target.value+"/1" , {
          method : "post" ,
          headers:{
      ...
      const reject = (e)=>{
        ...
        fetch ("https://server0826.herokuapp.com/hr/"+state._id+"/loan-reqs/"+e.target.value+"/2" , {
          method : "post" ,
          headers:{
            "Content-Type":"application/json",
            "Authorization":"Bearer "+localStorage.getItem("jwt")
